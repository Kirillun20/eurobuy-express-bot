    ...
    <div className="pb-20 overflow-hidden">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center px-4 py-16">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-0 pointer-events-none">
          <div className="animate-orbit">
            <div className="w-2 h-2 rounded-full bg-glow-primary/40" />
          </div>
        </div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-0 pointer-events-none">
          <div className="animate-orbit-reverse">
            <div className="w-1.5 h-1.5 rounded-full bg-glow-secondary/30" />
          </div>
        </div>
      ...
      <section className="px-4 py-8 max-w-lg mx-auto">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-40 h-40 bg-glow-primary/15 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-glow-secondary/10 rounded-full blur-3xl animate-pulse" />
          
          <div className="relative z-10 glass-strong rounded-2xl p-6 border-glow shadow-glow">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-display font-bold text-gradient">Доставка & Выкуп</h2>
                <p className="text-sm text-muted-foreground mt-1">Прямо в Беларусь (РБ)</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3 mb-5">
              {[
                { icon: '🇪🇺', label: 'Из Европы', value: '15+ стран' },
                { icon: '🚚', label: 'В Беларусь', value: 'Быстро' },
                { icon: '💳', label: 'Выкуп', value: 'Любой товар' },
                { icon: '⏱️', label: 'Доставка', value: '3-10 дней' },
              ].map(({ icon, label, value }) => (
                <motion.div
                  key={label}
                  whileHover={{ scale: 1.05 }}
                  className="glass rounded-xl p-3 text-center cursor-default group"
                >
            ...
            >
              <p className="flex items-center gap-2">
                ...
                Выкупаем товары из немецких, французских и других европейских интернет-магазинов
              </p>
              <p className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary/60" />
                Доставляем в Минск, Гомель и другие города Беларуси
              </p>
              <p className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary/60" />
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} className="flex-1">
                <Button
                  ...
                  className="gradient-primary glow-primary text-primary-foreground w-full font-semibold rounded-xl h-10"
                >
                  Начать заказ
                </Button>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                <Button
                  ...
                  className="glass border-glow rounded-xl h-10"
                >
                  Рассчитать
                </Button>
              </motion.div>
      ...
      <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Что говорят наши клиенты</p>
          </div>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              size="sm"
