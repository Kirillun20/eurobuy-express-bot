...
const faqItems = [
  ...
  { q: 'Как рассчитать стоимость?', a: 'Воспользуйтесь калькулятором — укажите стоимость товара, вес и способ доставки. Комиссия составляет 18% от стоимости товара или фиксированная цена за вес (выбирается большее). Точную сумму подтвердит менеджер.', icon: Calculator },
  ...
  { q: 'Что такое ЕвроБаллы?', a: 'ЕвроБаллы — это программа лояльности. За каждые 50 BYN в заказе вы получаете 1 балл. Баллы можно обменять на скидку на доставку (1 балл = 10 BYN) или процентные скидки от 2% до 10%.', icon: Star },
];
